...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone III" DIRECTION="ADD" OPTIMIZE="AREA" PIPELINE=7 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 aclr clock dataa datab nan overflow result underflow zero
...
module  fpadd_altbarrel_shift_q3e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fpadd_altbarrel_shift_q3e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpadd_altbarrel_shift_fkb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //fpadd_altbarrel_shift_fkb
...
module  fpadd_altpriority_encoder_6v7
	...
	fpadd_altpriority_encoder_3v7   altpriority_encoder16
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder16_q));
	fpadd_altpriority_encoder_3e8   altpriority_encoder17
	( 
	.data(data[3:2]),
...
module  fpadd_altpriority_encoder_6e8
	...
	fpadd_altpriority_encoder_3e8   altpriority_encoder19
	( 
	.data(data[3:2]),
...
module  fpadd_altpriority_encoder_bv7
	...
	fpadd_altpriority_encoder_6v7   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q));
	fpadd_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
module  fpadd_altpriority_encoder_be8
	...
	fpadd_altpriority_encoder_6e8   altpriority_encoder20
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder20_q),
	.zero(wire_altpriority_encoder20_zero));
	fpadd_altpriority_encoder_6e8   altpriority_encoder21
	( 
	.data(data[7:4]),
...
module  fpadd_altpriority_encoder_r08
	...
	fpadd_altpriority_encoder_bv7   altpriority_encoder12
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder12_q));
	fpadd_altpriority_encoder_be8   altpriority_encoder13
	( 
	.data(data[15:8]),
...
module  fpadd_altpriority_encoder_rf8
	...
	fpadd_altpriority_encoder_be8   altpriority_encoder22
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder22_q),
	.zero(wire_altpriority_encoder22_zero));
	fpadd_altpriority_encoder_be8   altpriority_encoder23
	( 
	.data(data[15:8]),
...
module  fpadd_altpriority_encoder_qb6
	...
	fpadd_altpriority_encoder_r08   altpriority_encoder10
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder10_q));
	fpadd_altpriority_encoder_rf8   altpriority_encoder11
	( 
	.data(data[31:16]),
...
module  fpadd_altpriority_encoder_qh8
	...
	fpadd_altpriority_encoder_nh8   altpriority_encoder30
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder30_q),
	.zero(wire_altpriority_encoder30_zero));
	fpadd_altpriority_encoder_nh8   altpriority_encoder31
	( 
	.data(data[3:2]),
...
module  fpadd_altpriority_encoder_vh8
	...
	fpadd_altpriority_encoder_qh8   altpriority_encoder28
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder28_q),
	.zero(wire_altpriority_encoder28_zero));
	fpadd_altpriority_encoder_qh8   altpriority_encoder29
	( 
	.data(data[7:4]),
...
module  fpadd_altpriority_encoder_fj8
	...
	fpadd_altpriority_encoder_vh8   altpriority_encoder26
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder26_q),
	.zero(wire_altpriority_encoder26_zero));
	fpadd_altpriority_encoder_vh8   altpriority_encoder27
	( 
	.data(data[15:8]),
...
module  fpadd_altpriority_encoder_q28
	...
	fpadd_altpriority_encoder_nh8   altpriority_encoder36
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder36_q),
	.zero(wire_altpriority_encoder36_zero));
	fpadd_altpriority_encoder_n28   altpriority_encoder37
	( 
	.data(data[3:2]),
...
module  fpadd_altpriority_encoder_v28
	...
	fpadd_altpriority_encoder_qh8   altpriority_encoder34
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder34_q),
	.zero(wire_altpriority_encoder34_zero));
	fpadd_altpriority_encoder_q28   altpriority_encoder35
	( 
	.data(data[7:4]),
...
module  fpadd_altpriority_encoder_f48
	...
	fpadd_altpriority_encoder_vh8   altpriority_encoder32
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder32_q),
	.zero(wire_altpriority_encoder32_zero));
	fpadd_altpriority_encoder_v28   altpriority_encoder33
	( 
	.data(data[15:8]),
...
module  fpadd_altpriority_encoder_e48
	...
	fpadd_altpriority_encoder_fj8   altpriority_encoder24
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder24_q),
	.zero(wire_altpriority_encoder24_zero));
	fpadd_altpriority_encoder_f48   altpriority_encoder25
	( 
	.data(data[31:16]),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpadd_altfp_add_sub_d4m
	( 
	aclr,
	clock,
	dataa,
...
`endif
	...
	fpadd_altbarrel_shift_q3e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fpadd_altbarrel_shift_fkb   rbarrel_shift
	( 
...
endmodule //fpadd_altfp_add_sub_d4m
//VALID FILE
...
module fpadd (
	...
	fpadd_altfp_add_sub_d4m	fpadd_altfp_add_sub_d4m_component (
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
				.aclr (aclr),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fpadd_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpadd_bb.v FALSE
